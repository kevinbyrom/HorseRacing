...
class CBitmap
	...
	public:
		...
		void Blit(CBitmap * pSrc, int x, int y, int width, int height, int sx, int sy);
		void Blit8(CBitmap * pSrc, int x, int y, int width, int height, int sx, int sy);
		void Blit16(CBitmap * pSrc, int x, int y, int width, int height, int sx, int sy);
		void Blit8To16(CBitmap * pSrc, int x, int y, int width, int height, int sx, int sy);
		void Blit16To8(CBitmap * pSrc, int x, int y, int width, int height, int sx, int sy);
